...
If you enable `redirect.keepRouteOnUnauthenticated`, the current route path
will be passed as a `?redirect=` query parameter to the login page, allowing
you to redirect the user back after re-authentication.
::
