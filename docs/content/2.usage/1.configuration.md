...
| `redirect.keepRouteOnUnauthenticated` | Determines whether to pass the current route as a `redirect` query parameter when redirecting on 401 responses | `false` |
